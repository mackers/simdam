...
BEGIN
    ...
    RETURN QUERY (
        SELECT
            ...
            ST_Distance(
                ST_SetSRID(ref_point, 4326),
                ST_SetSRID(points_nearby_equal_altitude.point, 4326)) AS distance
            FROM points_nearby_equal_altitude(ST_SetSRID(ref_point, 4326), area)
